...
`lec_replication_run/logs/deposit_outputs/`; the executed notebooks land in
`lec_replication_run/executed/`. This compares the two.
...
EXECUTED = os.path.join(ROOT, 'lec_replication_run', 'executed')
